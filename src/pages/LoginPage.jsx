...
const LoginPage = () => {
    return (
        <div className="login-page font-lato h-screen"
            style={{ 
                backgroundImage: `url("/properties/login.jpeg")`,
            ...
            <div className="flex justify-center py-20">
                <div className="bg-[#181A1C] bg-opacity-70 px-8 py-12 2xl:w-3/12 xl:w-4/12 lg:w-5/12 md:w-6/12 sm:w-7/12 w-11/12 rounded-lg">
                    ...
                    <h2 className="text-center text-white text-3xl font-bold">Masuk</h2>
                    <h4 className="text-center text-white mb-12">Selamat datang kembali</h4>

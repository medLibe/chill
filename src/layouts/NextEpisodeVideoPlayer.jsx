...
const NextEpisodeVideoPlayer = () => {
    return (
        <div className="absolute bottom-9 right-2 sm:bottom-10 sm:right-4 z-50 rounded-lg w-80 md:w-96">
            <div className="bg-[#3D4142] p-2">
                <h5 className="text-white font-bold text-xs md:text-sm">Episode Selanjutnya</h5>
            </div>
            <div className="bg-[#22282A] p-2 flex">
...
export default NextEpisodeVideoPlayer;